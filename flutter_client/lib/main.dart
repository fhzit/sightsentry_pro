            ...
            child: ListView(
              ...
              children: [
                ...
                _SettingsCard(children: [
                  ...
                  const Divider(height: 1, color: AppColors.divider, indent: 16),
                  SwitchListTile.adaptive(
                    value: controller.hideAccessPoints,
                    onChanged: controller.setHideAccessPoints,
                    activeThumbColor: AppColors.blue,
                    title: const Text('过滤 AP/路由器', style: TextStyle(color: AppColors.primaryText, fontWeight: FontWeight.w700)),
                    subtitle: const Text('隐藏由 Beacon / Probe Response 识别出的无线接入点', style: TextStyle(color: AppColors.secondaryText)),
                  ),
                ]),
              ],
            ),
